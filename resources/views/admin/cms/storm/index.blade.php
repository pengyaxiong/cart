...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">头脑风暴</strong> /
            <small>Storm Manage</small>
        </div>
    </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    <a class="am-btn am-btn-default" href="{{ route('cms.storm.create') }}">
                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{$storm->id}}">
                            <td>{{ $storm->id }}</td>
                            <td>
                                {!! @image_url($storm, ['class'=>'thumb']) !!}
                            </td>
                            <td>{{ $storm->title }}</td>

                            <td>{{ $storm->customer->nickname }}</td>

                            <td class="am-hide-sm-only">
                                {!! sub($storm->description) !!}
                            </td>

                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="{{ route('cms.storm.edit', $storm->id) }}">
                                            <span class="am-icon-list-alt"></span> 编辑
                                        </a>
                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" href="{{ route('cms.storm.destroy', $storm->id) }}" data-method="delete" data-token="{{csrf_token()}}" data-confirm="确定删除吗？">

...
@section('content')
    <div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加头脑风暴</strong> /
                <small>Create A New Storm</small>
            </div>
        </div>
        ...
        <form class="am-form" action="{{ route('cms.storm.store') }}" method="post">
            {{ csrf_field() }}

                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        @foreach($customers as $customer)
                            <tr data-id="{{ $customer->id }}">
                                ...
                                <td>
                                    <a class="am-badge am-badge-secondary" href="{{ route('shop.product.index', ['customer_id' => $customer->id]) }}">已经上传{{ $customer->products_count }}辆</a>
                                </td>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-xs am-text-secondary send_money"
                                               href="javascript:void (0)">
                                                <span class="am-icon-paper-plane"></span> 发放奖励
                                            </a>
                                        </div>
                                    </div>
                                </td>

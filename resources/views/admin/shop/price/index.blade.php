...
@section('content')
    <div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">价格区间</strong> /
                <small>Good Prices</small>
            </div>
        </div>
            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a class="am-btn am-btn-default" href="{{ route('shop.price.create') }}">
            ...
            <div class="am-u-sm-12">
                <form class="am-form">
                                    ...
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-xs am-text-secondary"
                                               href="{{route('shop.price.edit', $price->id)}}">
                                                <span class="am-icon-pencil-square-o"></span> 编辑
                                            </a>

                                            <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                                               href="{{route('shop.price.destroy', $price->id)}}" data-method="delete"
                    ...
                    <div class="am-cf">
                        共 {{$prices->total()}} 条记录
                        <div class="am-fr">
                            {!! $prices->appends(Request::all())->links() !!}
                        </div>
                    </div>
                    <hr/>

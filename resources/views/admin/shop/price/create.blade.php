...
@section('content')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增价格区间</strong> /
                <small>Create A New Price</small>
            </div>
        </div>

        @include('layouts.admin.partials._flash')

        <form class="am-form" action="{{ route('shop.price.store') }}" method="post">
            {{ csrf_field() }}

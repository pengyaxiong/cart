                    ...
                    <form class="am-form " action="{{route('system.config.update')}}" method="post">
                        ...
                        {{--<div class="am-g am-margin-top">--}}
                            {{--<div class="am-u-sm-4 am-u-md-3 am-text-right">--}}
                                {{--入会价格 <span class="am-badge am-badge-danger am-round">price</span>--}}
                            {{--</div>--}}
                            {{--<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">--}}
                                {{--<input type="text" name="price" value="{{$config->price}}">--}}
                            {{--</div>--}}
                        {{--</div>--}}

                        {{--<div class="am-g am-margin-top">--}}
                            {{--<div class="am-u-sm-4 am-u-md-3 am-text-right">--}}
                                {{--微信二维码 <span class="am-badge am-badge-warning am-round">weixin</span>--}}
                            {{--</div>--}}
                            {{--<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">--}}
                                {{--<div class="am-form-group am-form-file">--}}
                                    {{--<button type="button" class="am-btn am-btn-success am-btn-sm">--}}
                                        {{--<i class="am-icon-cloud-upload" id="weixin_loading"></i> 选择要上传的微信二维码--}}
                                    {{--</button>--}}
                                    {{--<input type="file" id="weixin_upload">--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        {{--<div class="am-g">--}}
                            ...
                            {{--<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">--}}
                                {{--<img src="/weixin.jpg?{!! get_millisecond() !!}" id="weixin_show"--}}
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-4 am-u-md-6">
                                <img src="/favicon.ico?{!! get_millisecond() !!}" id="img_show"
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" class="am-input-sm" name="service_mobile"
                                       value="{{$config->service_mobile}}">
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        ...
        //微信二维码
        var opts = {
            url: "/system/photo/upload_weixin",
            type: "POST",
            beforeSend: function () {
                $("#weixin_loading").attr("class", "am-icon-spinner am-icon-pulse");
            },
            success: function (result, status, xhr) {
                if (result.status == "0") {
                    alert(result.msg);
                    $("#weixin_loading").attr("class", "am-icon-cloud-upload");
                    return false;
                }

                $("#weixin_loading").attr("class", "am-icon-cloud-upload");
                var src = '/weixin.jpg?' + Math.random();
                $("#weixin_show").attr('src', src);
            },
            error: function (result, status, errorThrown) {
                alert('文件上传失败');
            }
        }
        $('#weixin_upload').fileUpload(opts);
    </script>
@endsection
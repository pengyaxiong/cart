...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $customers = Customer::withcount('products')->where($where)->paginate(config('admin.page_size'));
    ...
    public function show($id)
    {
        ...
        return view('admin.shop.customer.show', compact('customer'));
    }
    ...
    public function send_money(Request $request)
    {
        ...
        if ($result){
            return success_data('结算成功~');
        }else{
            return success_data('网络错误~');
        }
    }
}

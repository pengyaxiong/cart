...
class VisualizationController extends Controller
{
    ...
    {
        $this->week_start = mktime(0, 0, 0, date("m"), date("d") - date("w") + 1-7, date("Y"));
        $this->week_end = mktime(23, 59, 59, date("m"), date("d") - date("w") + 7-7, date("Y"));
...
//            DB::enableQueryLog();
    ...
    {
        $customers=Customer::withcount('products')->get();
